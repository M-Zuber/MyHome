...
namespace MyHome2013
{
    ...
    public partial class MonthChartUI : Form
    {
        ...
        private void LoadMe()
        {
            ...
            Dictionary<string, decimal> expenseData = eh.GetAllCategoryTotals(this.m_dtMonth);
            ...
            Dictionary<string, decimal> incomeData = ih.GetAllCategoryTotals(this.m_dtMonth);
